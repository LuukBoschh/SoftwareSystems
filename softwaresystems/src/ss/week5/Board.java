...
public class Board {
    ...
    public Board deepCopy() {
    	Board deepbord = new Board();
    	for(int i = 0; i<DIM*DIM;i++) {
    		deepbord.setField(i,this.getField(i));
    	}
    	return deepbord;
    }
    /**
    ...
    public boolean isField(int row, int col) {
        return (index(row,col)< DIM * DIM && 0<= index(row,col));
    }
    ...
    public Mark getField(int row, int col) {
        return bord[this.index(row, col)];
    }
    ...
    public boolean isEmptyField(int i) {
        return bord[i].equals(Mark.EMPTY);
    }
    ...
    public boolean isEmptyField(int row, int col) {
        return bord[this.index(row, col)].equals(Mark.EMPTY);
    }
    ...
    public boolean hasColumn(Mark m) {
    	return (bord[0] == m && bord[3] == m && bord[6] == m) || (bord[1] == m && bord[4] == m && bord[7] == m) || (bord[2] == m && bord[5] == m && bord[8] == m);
    }
